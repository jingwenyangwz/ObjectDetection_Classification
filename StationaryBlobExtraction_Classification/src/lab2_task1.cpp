...
//		// "/home/avsa/datasets/...
		string dataset_path = "/home/avsa/avss/2020AVSALab2_datasets"; //SET THIS DIRECTORY according to your download
		...
		string baseline_seq[4] = {"PETS2006/PETS2006_S1/PETS2006_S1_C3.mpeg","PETS2006/PETS2006_S4/PETS2006_S4_C3.avi","PETS2006/PETS2006_S5/PETS2006_S5_C3.mpeg"};
		//string baseline_seq[1] = {"PETS2006/PETS2006_S4/PETS2006_S4_C3.avi"};
...
//		string image_path = "/input/in%06d.jpg"; //path to images - this format allows to read consecutive images with filename inXXXXXX.jpq (six digits) starting with 000001
	...
	//	string image_path = ""; //path to images - this format allows to read consecutive images with filename inXXXXXX.jpq (six digits) starting with 00000
		...
		string project_root_path = "/home/avsa/avss/AVSA2020results"; //SET THIS DIRECTORY according to your project
		...
		for (int c=0; c<NumCat; c++ )
		{
			...
			Ptr<BackgroundSubtractor> pMOG2 = cv::createBackgroundSubtractorMOG2(history, varThreshold, detectShadows);
...
//			Ptr<BackgroundSubtractor> pMOG2 = cv::createBackgroundSubtractorMOG2();
			...
			for (;;) {
				...
				int morph_size = 3;// the size of the kernel to be used (morph_size)
				Mat element = getStructuringElement(0, // morpho_element:[ 0: Rect - 1: Cross - 2: Ellipse]
													Size( 2*morph_size + 1, 2*morph_size+1 ),
													Point( morph_size, morph_size ));
				morphologyEx(fgmask,// input image
							fgmask,	//output image
							2, //operation: The kind of morphology transformation to be performed. 2 refers Opening
							element);//The kernel to be used
				...
				int min_width=50;  // to set properly
				int min_height=50; // to set properly
