...
//		// "/home/avsa/datasets/...
		string dataset_path = "/home/peter/eclipse-workspace/Ex1_LoadModifySave/Lab2Dataset/2020AVSALab3_datasets/";
	...
	//	string image_path = ""; //path to images - this format allows to read consecutive images with filename inXXXXXX.jpq (six digits) starting with 000001
		...
		for (int c=0; c<NumCat; c++ )
		{
			...
			for (;;) {
				...
				int min_width=10;  // to set properly
				int min_height=10; // to set properly
